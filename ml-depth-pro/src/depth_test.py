...
image_path = "E:/opencv_practice/ml-depth-pro/data/DSC03160.jpg"
img = cv2.imread(image_path)

yolo_input  = cv2.resize(img, (1080, 720))
...
depth_colormap_resized = cv2.resize(depth_colormap, (1080, 720))
cv2.imshow('Person Detection', yolo_input)
